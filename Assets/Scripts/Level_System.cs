...
public class Level_System : MonoBehaviour 
{
	...
	void Start()
	{
		...
		Debug.Log ("level_slider.value:"+level_slider.value);
	...
	public void CheckLevelAchievement()
	{
		...
		{
				canDisplayOffer = true;
				level_badge.text = "2";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_2");
				level_2 = true;
				levelPlaying = 2;
		...
		{	
				level_badge.text = "3";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_3");
				level_3 = true;
				levelPlaying = 3;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_4 && currentLevelCounter >= level_achievement_4 && currentLevelCounter < level_achievement_5)
		{
				canDisplayOffer = true;
				level_badge.text = "4";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_4");
				level_4 = true;
				levelPlaying = 4;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		{
				level_badge.text = "5";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_5");
				level_5 = true;
				levelPlaying = 5;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_6 && currentLevelCounter >= level_achievement_6 && currentLevelCounter < level_achievement_7)
		{
				canDisplayOffer = true;
				level_badge.text = "6";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_6");
				level_6 = true;
				levelPlaying = 6;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		{
				level_badge.text = "7";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_7");
				level_7 = true;
				levelPlaying = 7;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_8 && currentLevelCounter >= level_achievement_8 && currentLevelCounter < level_achievement_9)
		{
			canDisplayOffer = true;
				level_badge.text = "8";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_8");
				level_8 = true;
				levelPlaying = 8;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		{
				level_badge.text = "9";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_9");
				level_9 = true;
				levelPlaying = 9;
				PlayerPrefs.SetInt("level playing", levelPlaying);
...
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_10");
				level_10 = true;
				levelPlaying = 10;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		{
				level_badge.text = "11";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_11");
				level_11 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_12 && currentLevelCounter >= level_achievement_12 && currentLevelCounter < level_achievement_13)
		{
			canDisplayOffer = true;
				level_badge.text = "12";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_12");
				level_12 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_13 && currentLevelCounter >= level_achievement_13 && currentLevelCounter < level_achievement_14)
		{
			canDisplayOffer = true;
				level_badge.text = "13";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_13");
				level_13 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_14 && currentLevelCounter >= level_achievement_14 && currentLevelCounter < level_achievement_15)
		{
			canDisplayOffer = true;
				level_badge.text = "14";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_14");
				level_14 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_15 && currentLevelCounter >= level_achievement_15 && currentLevelCounter < level_achievement_16)
		{
			canDisplayOffer = true;
				level_badge.text = "15";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_15");
				level_15 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_16 && currentLevelCounter >= level_achievement_16 && currentLevelCounter < level_achievement_17)
		{
			canDisplayOffer = true;
				level_badge.text = "16";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_16");
				level_16 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_17 && currentLevelCounter >= level_achievement_17 && currentLevelCounter < level_achievement_18)
		{
			canDisplayOffer = true;
				level_badge.text = "17";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_17");
				level_17 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_18 && currentLevelCounter >= level_achievement_18 && currentLevelCounter < level_achievement_19)
		{
			canDisplayOffer = true;
				level_badge.text = "18";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_18");
				level_18 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_19 && currentLevelCounter >= level_achievement_19 && currentLevelCounter < level_achievement_20)
		{
			canDisplayOffer = true;
				level_badge.text = "19";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_19");
				level_19 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
...
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_20");
				level_20 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_21 && currentLevelCounter >= level_achievement_21 && currentLevelCounter < level_achievement_22)
		{
			canDisplayOffer = true;
				level_badge.text = "21";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_21");
				level_21 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_22 && currentLevelCounter >= level_achievement_22 && currentLevelCounter < level_achievement_23)
		{
			canDisplayOffer = true;
				level_badge.text = "22";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_22");
				level_22 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_23 &&currentLevelCounter >= level_achievement_23 && currentLevelCounter < level_achievement_24)
		{
			canDisplayOffer = true;
				level_badge.text = "23";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_23");
				level_23 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_24 && currentLevelCounter >= level_achievement_24 && currentLevelCounter < level_achievement_25)
		{
			canDisplayOffer = true;
				level_badge.text = "24";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_24");
				level_24 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_25 && currentLevelCounter >= level_achievement_25 && currentLevelCounter < level_achievement_26)
		{
			canDisplayOffer = true;
				level_badge.text = "25";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_25");
				level_25 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_26 && currentLevelCounter >= level_achievement_26 && currentLevelCounter < level_achievement_27)
		{
			canDisplayOffer = true;
				level_badge.text = "26";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_26");
				level_26 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_27 && currentLevelCounter >= level_achievement_27 && currentLevelCounter < level_achievement_28)
		{
			canDisplayOffer = true;
				level_badge.text = "27";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_27");
				level_27 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_28 && currentLevelCounter >= level_achievement_28 && currentLevelCounter < level_achievement_29)
		{
			canDisplayOffer = true;
				level_badge.text = "28";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_28");
				level_28 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_29 && currentLevelCounter >= level_achievement_29 && currentLevelCounter < level_achievement_30)
		{
			canDisplayOffer = true;
				level_badge.text = "29";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_29");
				level_29 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
...
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_30");
				level_30 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_31 && currentLevelCounter >= level_achievement_31 && currentLevelCounter < level_achievement_32)
		{
			canDisplayOffer = true;
				level_badge.text = "31";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_31");
				level_31 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_32 && currentLevelCounter >= level_achievement_32 && currentLevelCounter < level_achievement_33)
		{
			canDisplayOffer = true;
				level_badge.text = "32";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_32");
				level_32 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_33 && currentLevelCounter >= level_achievement_33 && currentLevelCounter < level_achievement_34)
		{
			canDisplayOffer = true;
				level_badge.text = "33";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_33");
				level_33 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_34 && currentLevelCounter >= level_achievement_34 && currentLevelCounter < level_achievement_35)
		{
			canDisplayOffer = true;
				level_badge.text = "34";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_34");
				level_34 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_35 && currentLevelCounter >= level_achievement_35 && currentLevelCounter < level_achievement_36)
		{
			canDisplayOffer = true;
				level_badge.text = "35";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_35");
				level_35 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_36 && currentLevelCounter >= level_achievement_36 && currentLevelCounter < level_achievement_37)
		{
			canDisplayOffer = true;
				level_badge.text = "36";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_36");
				level_36 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_37 && currentLevelCounter >= level_achievement_37 && currentLevelCounter < level_achievement_38)
		{
			canDisplayOffer = true;
				level_badge.text = "37";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_37");
				level_37 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_38 && currentLevelCounter >= level_achievement_38 && currentLevelCounter < level_achievement_39)
		{
			canDisplayOffer = true;
				level_badge.text = "38";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_38");
				level_38 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_39 && currentLevelCounter >= level_achievement_39 && currentLevelCounter < level_achievement_40)
		{
			canDisplayOffer = true;
				level_badge.text = "39";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_39");
				level_39 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
...
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_40");
				level_40 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_41 && currentLevelCounter >= level_achievement_41 && currentLevelCounter < level_achievement_42)
		{
			canDisplayOffer = true;
				level_badge.text = "41";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_41");
				level_41 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_42 && currentLevelCounter >= level_achievement_42 && currentLevelCounter < level_achievement_43)
		{
			canDisplayOffer = true;
				level_badge.text = "42";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_42");
				level_42 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		{
				level_badge.text = "43";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_43");
				level_43 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_44 && currentLevelCounter >= level_achievement_44 && currentLevelCounter < level_achievement_45)
		{
			canDisplayOffer = true;
				level_badge.text = "44";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_44");
				level_44 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_45 && currentLevelCounter >= level_achievement_45 && currentLevelCounter < level_achievement_46)
		{
			canDisplayOffer = true;
				level_badge.text = "45";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_45");
				level_45 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_46 && currentLevelCounter >= level_achievement_46 && currentLevelCounter < level_achievement_47)
		{
			canDisplayOffer = true;
				level_badge.text = "46";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_46");
				level_46 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_47 && currentLevelCounter >= level_achievement_47 && currentLevelCounter < level_achievement_48)
		{
			canDisplayOffer = true;
				level_badge.text = "47";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_47");
				level_47 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_48 && currentLevelCounter >= level_achievement_48 && currentLevelCounter < level_achievement_49)
		{
			canDisplayOffer = true;
				level_badge.text = "48";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_48");
				level_48 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_49 && currentLevelCounter >= level_achievement_49 && currentLevelCounter < level_achievement_50)
		{
			canDisplayOffer = true;
				level_badge.text = "49";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_49");
				level_49 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
...
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_50");
				level_50 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_51 && currentLevelCounter >= level_achievement_51 && currentLevelCounter < level_achievement_52)
		{
			canDisplayOffer = true;
				level_badge.text = "51";
//				GameAnalytics.NewDesignEvent("Level_Achievement:Level_51");
				level_51 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_52 && currentLevelCounter >= level_achievement_52 && currentLevelCounter < level_achievement_53)
		{
			canDisplayOffer = true;
				level_badge.text = "52";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_52");
				level_52 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_53 && currentLevelCounter >= level_achievement_53 && currentLevelCounter < level_achievement_54)
		{
			canDisplayOffer = true;
				level_badge.text = "53";
				//GameAnalytics.NewDesignEvent("Level_Achievement:Level_53");
				level_53 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_54 && currentLevelCounter >= level_achievement_54 && currentLevelCounter < level_achievement_55)
		{
			canDisplayOffer = true;
				level_badge.text = "54";
				//GameAnalytics.NewDesignEvent("Level_Achievement:Level_54");
				level_54 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_55 && currentLevelCounter >= level_achievement_55 && currentLevelCounter < level_achievement_56)
		{
			canDisplayOffer = true;
				level_badge.text = "55";
				//GameAnalytics.NewDesignEvent("Level_Achievement:Level_55");
				level_55 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_56 && currentLevelCounter >= level_achievement_56 && currentLevelCounter < level_achievement_57)
		{
			canDisplayOffer = true;
				level_badge.text = "56";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_56");
				level_56 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_57 && currentLevelCounter >= level_achievement_57 && currentLevelCounter < level_achievement_58)
		{
			canDisplayOffer = true;
				level_badge.text = "57";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_57");
				level_57 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_58 && currentLevelCounter >= level_achievement_58 && currentLevelCounter < level_achievement_59)
		{
			canDisplayOffer = true;
				level_badge.text = "58";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_58");
				level_58 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_59 && currentLevelCounter >= level_achievement_59 && currentLevelCounter < level_achievement_60)
		{
			canDisplayOffer = true;
				level_badge.text = "59";
	//			GameAnalytics.NewDesignEvent("Level_Achievement:Level_59");
				level_59 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		//		GameAnalytics.NewDesignEvent("Level_Achievement:Level_60");
				level_60 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_61 && currentLevelCounter >= level_achievement_61 && currentLevelCounter < level_achievement_62)
		{
			canDisplayOffer = true;
				level_badge.text = "61";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_61");
				level_61 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_62 && currentLevelCounter >= level_achievement_62 && currentLevelCounter < level_achievement_63)
		{
			canDisplayOffer = true;
				level_badge.text = "62";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_62");
				level_62 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_63 && currentLevelCounter >= level_achievement_63 && currentLevelCounter < level_achievement_64)
		{
			canDisplayOffer = true;
				level_badge.text = "63";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_63");
				level_63 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_64 && currentLevelCounter >= level_achievement_64 && currentLevelCounter < level_achievement_65)
		{
			canDisplayOffer = true;
				level_badge.text = "64";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_64");
				level_64 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_65 && currentLevelCounter >= level_achievement_65 && currentLevelCounter < level_achievement_66)
		{
			canDisplayOffer = true;
				level_badge.text = "65";
		//		GameAnalytics.NewDesignEvent("Level_Achievement:Level_65");
				level_65 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_66 && currentLevelCounter >= level_achievement_66 && currentLevelCounter < level_achievement_67)
		{
			canDisplayOffer = true;
				level_badge.text = "66";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_66");
				level_66 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_67 && currentLevelCounter >= level_achievement_67 && currentLevelCounter < level_achievement_68)
		{
			canDisplayOffer = true;
				level_badge.text = "67";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_67");
				level_67 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_68 && currentLevelCounter >= level_achievement_68 && currentLevelCounter < level_achievement_69)
		{
			canDisplayOffer = true;
				level_badge.text = "68";
			//	GameAnalytics.NewDesignEvent("Level_Achievement:Level_68");
				level_68 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		else if(!level_69 && currentLevelCounter >= level_achievement_69 && currentLevelCounter < level_achievement_70)
		{
			canDisplayOffer = true;
				level_badge.text = "69";
		//		GameAnalytics.NewDesignEvent("Level_Achievement:Level_69");
				level_69 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
		...
		//		GameAnalytics.NewDesignEvent("Level_Achievement:Level_70");
				level_70 = true;
				levelPlaying++;
				PlayerPrefs.SetInt("level playing", levelPlaying);
