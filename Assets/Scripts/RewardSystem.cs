...
//	void OnEnable() 
//	{
//		AppLovin_Ad.InterstitialWatched += RewardInterstitialWatched;
//		InterstitialAdChartboost.ChartboostInterstitialWatched += RewardInterstitialWatched;
//	}
//	
//	void OnDisable() 
//	{
...
//		GameAnalytics.NewDesignEvent("BoughtCoins:DailyReward");
	}
	...
	{	
		...
		if (emailReward == "not awarded") 
		{
			...
			//GameAnalytics.NewDesignEvent("BoughtCoins:EmailReward");
		}
	}
