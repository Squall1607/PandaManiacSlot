...
//	private Level_System levelSystem;
	...
	public delegate void ShowInterstitial_Chartboost();
	public static event ShowInterstitial_Chartboost ShowChartboost;

	public delegate void ShowInterstitial_AppLovin();
	public static event ShowInterstitial_AppLovin ShowAppLovin;
...
//		levelSystem = levelSystemObj.GetComponent<Level_System>();
		...
		RewriteBet(def_bet_value.ToString("#.00"));
		RewriteBalance(def_balance_value.ToString("#.00"));
	}
...
//			}
	...
	public void SpinStopButton ()
	{
		...
		if(!spining && !bonusGame)
		{
			...
			if (def_bet_value == 5)
			{
//				GameAnalytics.NewDesignEvent("BetValue:5");
				Debug.Log ("event 5 sent");
			}
			else if(def_bet_value == 10)
			{
//				GameAnalytics.NewDesignEvent("BetValue:10");
				Debug.Log ("event 10 sent");
			}
			else if(def_bet_value == 25)
			{
//				GameAnalytics.NewDesignEvent("BetValue:25");
				Debug.Log ("event 25 sent");
			}
			else if(def_bet_value == 50)
			{
//				GameAnalytics.NewDesignEvent("BetValue:50");
				Debug.Log ("event 50 sent");
			}
			else if(def_bet_value == 100)
			{
//				GameAnalytics.NewDesignEvent("BetValue:100");
				Debug.Log ("event 100 sent");
			}
			else if(def_bet_value == 250)
			{
//				GameAnalytics.NewDesignEvent("BetValue:250");
				Debug.Log ("event 250 sent");
			}
			else if(def_bet_value == 500)
			{
//				GameAnalytics.NewDesignEvent("BetValue:500");
				Debug.Log ("event 500 sent");
			}
			else if(def_bet_value == 1000)
			{
//				GameAnalytics.NewDesignEvent("BetValue:1000");
				Debug.Log ("event 1000 sent");
			}
			else
			{
//				GameAnalytics.NewDesignEvent("BetValue:Other");
...
//					levelSystem.MoveLevelProgressBar();
					...
					if(showAd1)
					{
						if(ShowAppLovin != null)
						{
							ShowAppLovin();
						}
						else Debug.LogWarning ("NOTHING IS ASSIGN TO ShowAppLovin DELEGATE");
...
//			gameCenter.ReportScore(def_balance_value);
		...
		RewriteBalance ("" + def_balance_value.ToString("#.00"));
		RewriteWinValue("" + winAmount.ToString("#.00"));
...
//			gameCenter.ReportScore(def_balance_value);
		...
		PlayerPrefs.SetInt("balance", def_balance_value);
		RewriteBalance ("" + def_balance_value.ToString("#.00"));
		//RewriteWinValue("" + value.ToString("#.00"));
		bonusGame = false;
		Debug.Log (bonusGame);
