...
//	}
	...
	public void AddCoinsForReview()
	{
		if(review_coins == "not reviewed")
		{
			slot_machine.CreditBought(free_coins_for_review);
			PlayerPrefs.SetString("Review","is reviewed");
			Debug.LogWarning (PlayerPrefs.GetString("Review"));
			PlayerPrefs.SetInt ("rate_pop_up_count", 10);
//			GameAnalytics.NewDesignEvent("BoughtCoins:FreeReview");
		}
		...
		{
			Debug.Log ("PlayerPrefs dont match review string values");
		}
	}
